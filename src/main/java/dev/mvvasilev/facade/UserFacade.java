...
public class UserFacade {
    ...
    public String authenticateUser(AuthenticateUserDTO authenticateUserDTO) {
        Assert.notNull(authenticateUserDTO, "authenticateUserDTO cannot be null");

        return userService.generateUserToken(authenticateUserDTO.getEmail(), authenticateUserDTO.getRawPassword());
    }
}
